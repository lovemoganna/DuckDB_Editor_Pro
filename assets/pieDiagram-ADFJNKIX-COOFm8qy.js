import{g as U,s as H,a as K,b as V,p as Z,o as j,_ as s,l as w,c as q,D as J,H as Q,K as X,d as Y,x as ee,E as te}from"./vendor-mermaid-B5LlgtwT.js";import{p as ae}from"./chunk-4BX2VUAB-KQm5aCE9.js";import{p as re}from"./treemap-KMMF4GRG--8JgawhS.js";import{A as G,B as ie,C as se}from"./vendor-d3-C6NLcHOR.js";import"./vendor-codemirror-CGQFcGUm.js";import"./min-ChnVRjR3.js";import"./_baseUniq-kp4pBJNw.js";var le=te.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,oe=structuredClone(le),ne=s(()=>structuredClone(oe),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,ee()},"clear"),pe=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),de=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),W={getConfig:ne,clear:ce,setDiagramTitle:j,getDiagramTitle:Z,setAccTitle:V,getAccTitle:K,setAccDescription:H,getAccDescription:U,addSection:pe,getSections:de,setShowData:ge,getShowData:ue},fe=s((e,a)=>{ae(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),he={parse:s(async e=>{const a=await re("pie",e);w.debug(a),fe(a,W)},"parse")},me=s(e=>`
  .pieCircle{
