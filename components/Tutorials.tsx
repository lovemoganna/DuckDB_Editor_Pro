...
interface Lesson {
    id: string;
    category: 'Foundations' | 'Data Cleaning' | 'Complex Types' | 'Time Series' | 'Analytics' | 'Utilities';
    title: string;
    description: string;
    whyItMatters: string;
    code: string;
...
export const Tutorials: React.FC<TutorialsProps> = ({ onTryCode }) => {
    ...
    const [expandedCategories, setExpandedCategories] = useState<Set<string>>(new Set(['Foundations', 'Data Cleaning', 'Analytics']));
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex gap-2">
                                            <span className={`text-[9px] uppercase px-1.5 py-0.5 rounded font-bold opacity-80 ${
                                                lesson.difficulty === 'Beginner' ? 'text-monokai-green bg-monokai-green/10' :
                                                lesson.difficulty === 'Intermediate' ? 'text-monokai-orange bg-monokai-orange/10' :
                                                'text-monokai-purple bg-monokai-purple/10'
                                            }`}>
                                                {lesson.difficulty}
                                            </span>
                                        </div>
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <span className={`text-xs font-bold px-3 py-1 rounded-full border ${
                                        activeLesson.difficulty === 'Beginner' ? 'border-monokai-green text-monokai-green' :
                                        activeLesson.difficulty === 'Intermediate' ? 'border-monokai-orange text-monokai-orange' :
                                        'border-monokai-purple text-monokai-purple'
                                    }`}>
                                ...
                                <pre className="text-sm font-mono !bg-transparent !m-0 !p-0">
                                    <code 
                                        ...
                                        dangerouslySetInnerHTML={{
                                            __html: Prism.highlight(activeLesson.code, Prism.languages.sql, 'sql')
                                        }}
                                    />
                                </pre>
                            </div>
